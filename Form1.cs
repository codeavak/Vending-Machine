...
namespace drink
{
    public partial class VendingMachine : Form
    {
        ...
        Beverage Cola;
        Beverage CreamSoda; Beverage GrapeSoda;
        Beverage LemonLime; Beverage RootBeer;
        double total = 0;
        ...
        struct Beverage
        {
            ...
            {if (NumberRemaining > 0)
                { NumberRemaining--; return true; }
                else { MessageBox.Show("No more cans of this beverage are left in the machine. Please try again later!"); return false; }
        ...
        void MyButtonClick(object sender, EventArgs e)
        {
            ...
            {
                case "pictureBox1": {if( Cola.Dispense()) total += Cola.Cost; UpdateTotal(); UpdateCounts(); } break;
                case "pictureBox2": { if (CreamSoda.Dispense()) total += CreamSoda.Cost; UpdateTotal(); UpdateCounts(); } break;
                case "pictureBox3": { if (GrapeSoda.Dispense()) total += GrapeSoda.Cost; UpdateTotal(); UpdateCounts(); } break;
                case "pictureBox4": { if (LemonLime.Dispense()) total += LemonLime.Cost; UpdateTotal(); UpdateCounts(); } break;
                case "pictureBox5": { if (RootBeer.Dispense()) total += RootBeer.Cost; UpdateTotal(); UpdateCounts(); } break;
            }
